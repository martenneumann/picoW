...
gpio_hBrueckeENB			= 20	# Pin um den Elektromagneten einzuschalten
gpio_hBrueckeIn4			= 19	# Pin um den Elektromagneten einzuschalten
gpio_hBrueckeIn3			= 18	# Pin um den Elektromagneten einzuschalten
gpio_hBrueckeIn2			= 17	# 
gpio_hBrueckeIn1			= 16	# 
...
speed_schrittweite_Turmmotor	= 5000				# Drehgeschwindigkeit Turmmotor in steps ns
...
abbruchsZeitInMs_ZugReinfahren 	= 3000				# In Ms. Nach dieser Zeit schaltet die H-Brücke ab. Damit Zug nicht zuweit fährt. Kann auch genutzt werden,
...
abbruchsZeitInMs_ZugRausfahren  = 5000
